...
export interface SlideCtxValue { isThumbnail: boolean; hideOverflowBadge: boolean; textColor: string; mermaidInit: string; tocNumbered: boolean; onDiagramReady?: () => void; onNavigateTo?: (slideIndex: number) => void }
