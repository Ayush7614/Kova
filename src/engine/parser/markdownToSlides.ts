...
// black, rebeccapurple, …). Anything containing spaces, quotes, or CSS
// metacharacters (`;`, `{`, `}`) is rejected so the value can't be used to
// inject extra declarations when later placed into a `style` attribute.
